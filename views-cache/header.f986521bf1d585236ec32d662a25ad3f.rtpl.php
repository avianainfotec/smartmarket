...
<head>
  ...
  <title>Smart Market | Aviana Infotec</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/users"><i class="fa fa-users"></i> <span>Uruários</span></a></li>
        <li><a href="/admin/categories"><i class="fa fa-th-large"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/products"><i class="fa fa-empire"></i> <span>Produtos</span></a></li>
        <li class="treeview">
